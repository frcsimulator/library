...
public class Simulator extends Thread {
	...
	public static class Status {
		...
		/**
		 * The watchdog is enabled but has not been fed, this is only a notification, the simulator continues running to make debugging easier.
		 */
		...
		/**
		 *
		 * @return True if the simulator is running, initializing, or if the watchdog is not fed..
		 */
