...
public class DriverStation implements IInputOutput {
    ...
    //private final Semaphore m_packetDataAvailableSem; @TODO figure out how to not use a semaphore
    ...
    protected DriverStation() {
        ...
        //m_packetDataAvailableSem = new Semaphore(options, false); @TODO figure out how to not use a semaphore
        //FRCControl.setNewDataSem(m_packetDataAvailableSem); @TODO figure out how to not use a semaphore
    ...
    private void task() {
        ...
        while (m_thread_keepalive) {
            //try {@TODO figure out how to not use a semaphore
                //m_packetDataAvailableSem.takeForever(); @TODO figure out how to not use a semaphore
                synchronized (this) {
                    getData();
                ...
                //} @TODO figure out how to not use a semaphore
            //} catch (SemaphoreException ex) { @TODO figure out how to not use a semaphore
                //
            }
        }
    }
    ...
    protected void setData() {
        synchronized (m_semaphore) {
            FRCControl.setStatusData(getBatteryVoltage(), m_digitalOut,
                    m_updateNumber,
                    m_dashboardInUseHigh.getBytes(),
                    m_dashboardInUseHigh.getBytesLength(),
                    m_dashboardInUseLow.getBytes(),
                    m_dashboardInUseLow.getBytesLength(),
                    Semaphore.WAIT_FOREVER);
    ...
    public double getBatteryVoltage() {
        ...
        return 0; //Because there is no battery!
    }
