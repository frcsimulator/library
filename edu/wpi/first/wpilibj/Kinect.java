 ...
 *
 */
public class Kinect implements FrcBotSimComponent{
    ...
    class header_block_t extends FRCControl.DynamicControlData {
...

        {
            //allocateMemory();
            data = new header_t(
                    null/*new Pointer(backingNativeMemory.address().toUWord().toPrimitive() + 2,
                    header_t.size)*/);
        }
