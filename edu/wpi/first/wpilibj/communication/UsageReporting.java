...
public final class UsageReporting {
    ...
    private static final class nUsageReporting_reportFn {
        public static int call4(int arg0, int arg1, int arg2, Pointer arg3){
            Simulator.fixme(UsageReporting.class,Thread.currentThread(),"nUsageReporting_reportFN stubbed");
            return 0;
        }
    }
