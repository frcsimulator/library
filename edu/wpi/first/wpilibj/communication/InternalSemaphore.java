...
abstract class InternalSemaphore {
	...
	/**
	 * Attempt to wait forever on the semaphore. Called in a loop by takeMillis()
	 * to catch InterruptedExceptions.
	 * @throws SemaphoreException
	 ...
	 * Actually does nothing; this is for VxWorks semaphores.
	 * @throws SemaphoreException
	 */
