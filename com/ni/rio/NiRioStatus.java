...
public class NiRioStatus
{
   ...
   public NiRioStatus()
   {
      status = kRioStatusSuccess;//new IntByReference(kRioStatusSuccess);
   }
   ...
   {
       throw new UnsimulatedOperationException("It's not polite to point");
   ...
   {
      if (status >= 0 && (status == 0 || newStatusCode < 0))
      {
